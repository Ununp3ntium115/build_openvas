...
impl CryptexError {
    ...
    /// Create a Network error (for non-reqwest network errors)
    pub fn network<S: Into<String>>(msg: S) -> Self {
        // Convert string to a reqwest error by parsing as anyhow and wrapping
        // Since NetworkError expects reqwest::Error, we'll use AgitatorError for custom messages
